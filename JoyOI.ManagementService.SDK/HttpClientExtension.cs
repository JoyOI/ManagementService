...
namespace JoyOI.ManagementService.SDK
{
    public static class HttpClientExtension
    {
        ...
        public static Task<HttpResponseMessage> PatchAsync(this HttpClient client, string endpoint, HttpContent content, CancellationToken cancellationToken = default(CancellationToken)) => client.PatchAsync(new Uri(endpoint, UriKind.Relative), content, cancellationToken);
    }
}
